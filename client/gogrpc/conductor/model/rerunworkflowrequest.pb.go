...
func (*RerunWorkflowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rerunworkflowrequest_f4142b4477bfa309, []int{0}
}
...
func init() {
	proto.RegisterFile("model/rerunworkflowrequest.proto", fileDescriptor_rerunworkflowrequest_f4142b4477bfa309)
}

var fileDescriptor_rerunworkflowrequest_f4142b4477bfa309 = []byte{
