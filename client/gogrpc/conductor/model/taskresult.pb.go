...
func (TaskResult_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_taskresult_966839810532bfae, []int{0, 0}
}
...
func (*TaskResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_taskresult_966839810532bfae, []int{0}
}
...
func init() { proto.RegisterFile("model/taskresult.proto", fileDescriptor_taskresult_966839810532bfae) }

var fileDescriptor_taskresult_966839810532bfae = []byte{
