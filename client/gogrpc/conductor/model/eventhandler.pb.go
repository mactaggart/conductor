...
func (EventHandler_Action_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eventhandler_c4e705ee31459afc, []int{0, 2, 0}
}
...
func (*EventHandler) Descriptor() ([]byte, []int) {
	return fileDescriptor_eventhandler_c4e705ee31459afc, []int{0}
}
...
func (*EventHandler_StartWorkflow) Descriptor() ([]byte, []int) {
	return fileDescriptor_eventhandler_c4e705ee31459afc, []int{0, 0}
}
...
func (*EventHandler_TaskDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_eventhandler_c4e705ee31459afc, []int{0, 1}
}
...
func (*EventHandler_Action) Descriptor() ([]byte, []int) {
	return fileDescriptor_eventhandler_c4e705ee31459afc, []int{0, 2}
}
...
func init() {
	proto.RegisterFile("model/eventhandler.proto", fileDescriptor_eventhandler_c4e705ee31459afc)
}

var fileDescriptor_eventhandler_c4e705ee31459afc = []byte{
