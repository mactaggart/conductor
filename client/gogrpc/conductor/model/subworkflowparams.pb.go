...
func (*SubWorkflowParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_subworkflowparams_862ac84c4ed27809, []int{0}
}
...
func init() {
	proto.RegisterFile("model/subworkflowparams.proto", fileDescriptor_subworkflowparams_862ac84c4ed27809)
}

var fileDescriptor_subworkflowparams_862ac84c4ed27809 = []byte{
